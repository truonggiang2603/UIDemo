// Utility functions and page templates extension

// Extend the app object with additional page templates and functionality
window.addEventListener('DOMContentLoaded', function() {
    // Wait for app to be initialized
    setTimeout(() => {
        if (window.app) {
            // Add page template methods
            Object.assign(window.app, {
                ...
                getMapContent() {
                    return `
                        <div class="map-container">
                            ...
                            <!-- Map Markers -->
                            <div class="map-marker temple" style="top: 150px; left: 150px;" data-spot-id="2"></div>
                            <div class="map-marker food" style="top: 250px; left: 320px;" data-spot-id="3"></div>
                            <div class="map-marker craft" style="top: 350px; left: 100px;" data-spot-id="1"></div>
                            <div class="map-marker art" style="top: 400px; left: 250px;" data-spot-id="4"></div>
                            ...
                            <div class="map-overlay" id="mapOverlay" style="display: none;">
                                <div class="flex items-start">
                                    <div class="w-20 h-20 rounded-lg bg-primary-light flex-shrink-0" id="overlayImage"></div>
                                    <div class="ml-3 flex-1">
                                        <h3 class="font-semibold" id="overlayTitle">Chùa Thiên Mụ</h3>
                                        <div class="flex mt-1" id="overlayTags">
                                            <span class="tag">Đền chùa</span>
                                            <span class="tag">Di tích</span>
                                        </div>
                                        <p class="text-xs text-gray-600 mt-2" id="overlayDescription">Ngôi chùa cổ nhất thành phố Huế, được xây dựng từ năm 1601 với kiến trúc độc đáo.</p>
                                    </div>
                                </div>
                                <button class="action-button w-full mt-4" onclick="window.app.addToTrip()">Thêm vào hành trình</button>
                            </div>
                ...
                getExploreContent() {
                    const spot = this.currentSpot || mockData.heritageSpots[0];
                    return `
